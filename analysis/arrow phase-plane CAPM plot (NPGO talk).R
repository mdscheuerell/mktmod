...
par(mai=c(0.9,0.9,0,0), omi=rep(0.1,4))
matplot(t.index, prod.pop[,names.mat$ID], type="n", col=col.pal, lwd=1.5,
		ylab="ln[R/S] or NPGO", xlab="Brood year", cex.axis=1.2, cex.lab=1.5, las=1)
matplot(t.index, prod.pop[,names.mat$ID], type="n", col=col.pal, lwd=1.5,
...
dev.off()
png("spawner density vs year (NPGO mkt 64-06).png", width=9, height=5, units="in", res=300)
...
dev.off()
png("Sp alpha vs year (NPGO mkt 64-06).png", width=9, height=5, units="in", res=300)
...
dev.off()
png("Sp beta vs year (NPGO mkt 64-06).png", width=9, height=5, units="in", res=300)
...
dev.off()
png("Sp beta vs return (NPGO mkt 0 risk 64-06).png", width=9, height=5, units="in", res=300)
...
png("beta vs return (NPGO mkt index).png", width=9, height=5, units="in", res=300)
dev.off()
